...
public class DbConn {
    ...
    public DbConn() {
        ...
        String dbAndPass = "sp21_3308_tuf93296?user=tuf93296&password=rusoosoh";
        ...
        try {
            ...
            try {
                ...
                recordError("Problem connecting to database, contact adminstrator. Error:" + e.getMessage());
            }
        } catch (Exception e) { // cant get the driver...
            recordError("Problem getting driver, please contact an adminstrator. Error:" + e.getMessage());
        }
    } // method
    ...
    private boolean isTemple() {
        ...
        try {
            ...
            recordError("Database unavailable, please contact administrator. Error: " + e.getMessage());
        }
        return temple;
    }
